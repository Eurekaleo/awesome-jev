...
# Jev and Typed Decision Models: An Evidence Survey

**An empirical survey and evidence audit of TypeSafe’s Jev and Jev-like typed decision models — calibration, selective control and open implementations.** Data cutoff **23 Sep 2026** (Asia/Singapore), with a same-day incremental rerun.

67 references (13 core · 1 peripheral · 53 background) · 62 evidence records with locators · 30 open resources audited · 7 cross-cutting findings

**Website:** <https://eurekaleo.github.io/awesome-jev-survey/>

**Author:** [Meng Luo](https://eurekaleo.github.io/)

> Values are as reported by paper authors, the vendor or repository maintainers. None of the experiments was re-run for this survey, and nothing here is a unified leaderboard.

## Contents

- [At a glance](#at-a-glance)
- [Seven findings](#seven-findings)
...
| --- | ---: | --- |
| Core studies | 13 | Study TypeSafe Jev, a clearly identified Jev-like typed-decision implementation, or a system that materially depends on one; read in full. |
| Peripheral study | 1 | Within reach of the scope but with contested, self-reported claims; not pooled with core evidence. |
| Background references | 53 | 44 purposive seed references from the snapshot + 9 added by the same-day increment; metadata/abstract depth. |
| Evidence records | 62 | 44 from papers, the rest from vendor documentation and community repositories; each with locator, scope and sample size. |
| arXiv queries (snapshot) | 17 | 225 hits → 197 unique records screened. |
| Increment expansion queries | 19 | 128 new records screened; 9 added as background. |
| Catalogues audited | 81 | 79 READMEs at pinned commits. |
| Priority resources | 30 | 2 of them are also in the catalogue set; 12 source files read, none executed. |
| GitHub discovery results | 1,082 | De-duplicated search results at the snapshot (a discovery pool, not a census). |
| Outgoing README links | 4,666 | Unverified candidates. **Not** validated Jev projects and not counted anywhere else. |
...
¹ Same study family (shared authors and service path); not independent replications. Code: ● located · ◐ partial · ◔ project page only · ○ not located in this review (not evidence of absence) · “claimed” = the paper says it is released.
...
Availability at pinned commits: ● available · ◐ partial · ◑ restricted · ◔ project page only · ○ not located · – not applicable. Nothing was executed.
...
- [SalesRLAgent: A Reinforcement Learning Approach for Real-Time Sales Conversion Prediction and Optimization](https://arxiv.org/abs/2503.23303v1) (2025) — SalesRLAgent (2025): domain probabilistic decisions; historically related work that does not establish shared architecture, performance or copying.
...
- [Benchmarking Zero-shot Text Classification: Datasets, Evaluation and Entailment Approach](https://arxiv.org/abs/1909.00161v1) (2019 · EMNLP 2019 (per arXiv comment)) — Zero-shot text classification with NLI-style label descriptions: historical context for runtime-defined option semantics.
...
- [Target-Checked Reliability Score Refinement for Video Question Answering](https://arxiv.org/abs/2609.13288v1) (2026) · *added 2026-09-23 increment* — Answer-level reliability scores built from option-probability lists can be refined under target shift, without changing answers, when a labelled target pilot exists.
- [Reliable Financial Named Entity Recognition Under Domain Shift: Confidence Estimation and Selective Prediction](https://arxiv.org/abs/2608.19558v2) (2026) · *added 2026-09-23 increment* — Under domain shift the ranking of confidence signals changes: whole-output probability is the best in-domain error detector but degrades out of domain.
- [Model Confidence Under Answer-Preserving Attacks: An Informativeness-Manipulability Frontier](https://arxiv.org/abs/2608.06571v1) (2026) · *added 2026-09-23 increment* — Answer-preserving attacks move confidence readouts, bounding what confidence gates can certify.
- [Uncertainty Quantification and Confidence Calibration in Large Language Models: A Survey](https://arxiv.org/abs/2503.15850v2) (2025) — Survey of uncertainty quantification and calibration in LLMs: locates the boundary of existing reviews.
- [Rewarding Doubt: A Reinforcement Learning Approach to Calibrated Confidence Expression of Large Language Models](https://arxiv.org/abs/2503.02623v6) (2025) — Rewarding Doubt: RL for calibrated confidence expression; not an official technical paper of Jev or any open model.
- [Semantic Uncertainty: Linguistic Invariances for Uncertainty Estimation in Natural Language Generation](https://arxiv.org/abs/2302.09664v3) (2023 · ICLR 2023 (per arXiv comment)) — Semantic uncertainty: an alternative definition of confidence for generative models.
...
- [Can You Trust Your Model's Uncertainty? Evaluating Predictive Uncertainty Under Dataset Shift](https://arxiv.org/abs/1906.02530v2) (2019 · NeurIPS 2019 (per arXiv comment)) — Predictive uncertainty under dataset shift: in-distribution calibration does not transfer to shifted data.
- [On Calibration of Modern Neural Networks](https://arxiv.org/abs/1706.04599v2) (2017 · ICML 2017 (per arXiv comment)) — Calibration of modern neural networks and temperature scaling: the post-hoc baseline for any returned probability.

### Selective prediction & deferral

- [When to Call an LLM: A Confidence-Gated Hybrid for Cost-Effective Emotion Recognition in Conversational AI](https://arxiv.org/abs/2609.17977v1) (2026) · *added 2026-09-23 increment* — A cheap stacked ensemble that escalates only its least-confident predictions to an LLM; on IEMOCAP the ensemble alone beat every LLM configuration — trained cheap models are the first baseline for escalation designs.
- [Conformity Breaks Conformal Prediction](https://arxiv.org/abs/2609.04445v1) (2026) · *added 2026-09-23 increment* — Conformal coverage calibrated in isolation breaks under a score-mechanism shift (peer pressure); an attacker can target the low-confidence items a gate still covers.
...
- [Consistent Estimators for Learning to Defer to an Expert](https://arxiv.org/abs/2006.01862v3) (2020 · ICML 2020 (per arXiv comment)) — Learning to defer: modelling expert cost jointly with prediction error.
- [SelectiveNet: A Deep Neural Network with an Integrated Reject Option](https://arxiv.org/abs/1901.09192v4) (2019 · ICML 2019 (per arXiv comment)) — SelectiveNet: jointly learning prediction and a reject option.
...
- [Smooth Calibration and Decision Making](https://arxiv.org/abs/2504.15582v1) (2025 · FORC 2025 (per arXiv comment)) — Smooth calibration and decision making.
- [Calibration Error for Decision Making](https://arxiv.org/abs/2404.13503v5) (2024 · FOCS 2024 (per arXiv comment)) — Calibration error for decision making: a utility-aware alternative to a single ECE.
...
- [Decision-Focused Learning: Foundations, State of the Art, Benchmark and Future Opportunities](https://arxiv.org/abs/2307.13565v4) (2023 · Journal of Artificial Intelligence Research 81 (2024) 1623-1701 (per arXiv journal ref)) — Decision-focused learning survey; its optimisation semantics differ from an API returning a choice.

### Structured output & efficient inference

- [SAGE: A Unified Algebra and Self-Adaptive Execution for AI Functions in SQL](https://arxiv.org/abs/2608.20630v1) (2026) · *added 2026-09-23 increment* — Typed AI primitives with a shared confidence-gated execution interface in SQL: the same design pattern arising independently in data systems.
- [The Calibration Floor: Format Repair Can Masquerade as Self-Correction at Small-to-Mid Scale](https://arxiv.org/abs/2608.04355v1) (2026) · *added 2026-09-23 increment* — Format recovery can masquerade as reasoning gains; grammar-constrained decoding closes much of the gap, so parseability must be separated from content when typed and generative outputs are compared.
...
- [XGrammar: Flexible and Efficient Structured Generation Engine for Large Language Models](https://arxiv.org/abs/2411.15100v3) (2024 · MLSys 2025 (per arXiv comment)) — XGrammar: an efficient constrained-decoding engine for fair generative baselines.
...
- [PICARD: Parsing Incrementally for Constrained Auto-Regressive Decoding from Language Models](https://arxiv.org/abs/2109.05093v1) (2021 · EMNLP 2021 (per arXiv comment)) — PICARD: incremental constrained autoregressive decoding, a historical structured-output baseline.
...
- [Prometheus: Inducing Fine-grained Evaluation Capability in Language Models](https://arxiv.org/abs/2310.08491v2) (2023 · ICLR 2024 (per arXiv comment)) — Prometheus: a dedicated evaluator model and a relevant baseline for decision-only judging.
- [Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena](https://arxiv.org/abs/2306.05685v4) (2023 · NeurIPS Datasets and Benchmarks 2023 (per arXiv comment)) — MT-Bench and Chatbot Arena: foundations and biases of LLM-as-a-judge.
...
- [Confidence-Aware Routing for Large Language Model Reliability Enhancement: A Multi-Signal Approach to Pre-Generation Hallucination Mitigation](https://arxiv.org/abs/2510.01237v1) (2025) — Confidence-aware routing; an author connection to an open project does not establish shared training, architecture or priority.
...
- [Marginal Fidelity Does Not Establish User Simulation in Demographic Synthetic Survey Panels: Response Contracts, Support Collapse and Conditioning Failure](https://arxiv.org/abs/2609.07305v1) (2026) · *added 2026-09-23 increment* — In synthetic survey panels the response contract (committed sets vs per-option probabilities) dominates measured fidelity — the same interface dependence seen with Noul vs Choice.
...
- [Entity Binding Failures in Tool-Augmented Agents](https://arxiv.org/abs/2606.30531v1) (2026) · *added 2026-09-23 increment* — Entity binding failures — the right tool acting on the wrong entity — separate tool correctness from entity correctness, a close analogue of option-name binding.
- [Quantifying Language Models' Sensitivity to Spurious Features in Prompt Design or: How I learned to start worrying about prompt formatting](https://arxiv.org/abs/2310.11324v2) (2023 · ICLR 2024 (per arXiv comment)) — Sensitivity to spurious prompt-format features: a template for order and format invariance tests.
...
A public working draft, [*Decisions, Not Tokens: A Survey of Typed, Calibrated, and Machine-Native Decision Models from Classical Classifiers to Jev*](https://github.com/youzizzz1028/Awesome-Jev/blob/f3703012b0034eefe0d59936c44cd33ea11b2990/paper/main.tex) (dated 21 September 2026), precedes this survey and shares its separation of validity, correctness, calibration and utility. Its bibliography (at the pinned commit) contains none of the 13 core arXiv IDs reviewed here. See [docs/related-surveys.md](docs/related-surveys.md) for the dimension-by-dimension comparison. This survey makes no priority claim.

## Method and reproducibility

- Search protocol, screening and reading depth: [docs/methodology.md](docs/methodology.md); logs in [`data/search-runs.json`](data/search-runs.json) and [`research/`](research/).
- Evidence audit rules (measurement scopes, openness fields): [docs/evidence-audit.md](docs/evidence-audit.md). Limitations: [docs/limitations.md](docs/limitations.md).
- Survey draft: [paper/survey.md](paper/survey.md) (Markdown) and [paper/main.tex](paper/main.tex) (LaTeX; build with `latexmk -pdf main.tex` in `paper/`).

```sh
python3 scripts/validate-data.py   # integrity and vocabulary checks
python3 scripts/build.py           # site, README, BibTeX, CSV, stats
python3 scripts/check-links.py     # link check (network)
python3 scripts/update-metadata.py # new dated arXiv increment (never overwrites the snapshot)
python3 scripts/update-github.py   # new dated GitHub discovery increment
```

## Repository layout

```text
data/        canonical records (papers, claims, repositories, taxonomy, relations, sources, search runs) + generated exports
site/        page template, CSS, JavaScript and lazily loaded drawer data; index.html is generated
paper/       survey manuscript (Markdown and LaTeX) and its bibliography
docs/        methodology, evidence audit, related surveys, limitations, reference study, deployment, 中文交接
research/    immutable 2026-09-23 snapshot, dated increments and the frozen editorial curation used to bootstrap data/
scripts/     validation, build, exports, link check, incremental updates
tests/       unit tests for data rules and client-side search
```

## Contributing

New studies, corrections, code or weights updates and reproduction reports are welcome — see [CONTRIBUTING.md](CONTRIBUTING.md). Edit `data/*.json`, never the generated files, and run the build before opening a pull request.
Open an issue: <https://github.com/Eurekaleo/awesome-jev-survey/issues/new/choose>.

## Citation and licence

Citation metadata is in [CITATION.cff](CITATION.cff) (GitHub shows it under “Cite this repository”). This is a working draft: it has no DOI and has not been peer-reviewed or submitted anywhere.
